...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		correlator.injectMonitorscript(['DataSourceServiceTest001.mon'], self.input)
		self.waitForSignal('correlator.out', expr='SourceIds Response \(just leaf nodes\):', condition='==3', timeout=10)
