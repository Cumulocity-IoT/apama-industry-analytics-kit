...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		self.waitForSignal('correlator.out', expr='Analytic Mapper started for inputDataNames', condition='==4', timeout=5)

		correlator.send('Events.evt')
		self.waitForSignal('ZVAL.evt', expr='com\.industry\.analytics\.Data', condition='==4', timeout=5)
