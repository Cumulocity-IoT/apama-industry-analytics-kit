...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		self.waitForSignal('correlator.out', expr='Analytic Sorter started for inputDataNames', condition='==2', timeout=5)
		correlator.send('Events.evt')
		self.waitForSignal('Output2.evt',
						   expr='com\.industry\.analytics\.Data\("Output2","a","s2",160,2\.3,"",1,2,3,\{"anomalySource":"Sorter"\}\)',
						   condition='==1',
						   timeout=5)
