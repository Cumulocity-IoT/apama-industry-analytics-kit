...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		self.waitForSignal('Output1.evt', expr='com.industry.analytics\.Data', condition='==30', timeout=5)
	...
	def validate(self):
		...
		exprList=[]
		exprList.append('Validating com.industry.analytics.Analytic\("Repeater",\["Input1"\],\["Output1"\],{"interval":"5.0"}\)')
