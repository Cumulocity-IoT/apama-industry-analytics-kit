...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		correlator.sendEventStrings('com.industry.analytics.Analytic("Prediction", ["SEPAL_LE", "SEPAL_WI", "PETAL_LE", "PETAL_WI"], ["predictedValue_CLASS", "Cluster ID", "Cluster Affinity for predicted", "Cluster Affinity for setosa", "Cluster Affinity for versic", "Cluster Affinity for virgin"], {"SEPAL_LE":"SEPAL_LE.DVALUE", "SEPAL_WI":"SEPAL_WI.DVALUE", "PETAL_LE":"PETAL_LE.DVALUE", "PETAL_WI":"PETAL_WI.DVALUE", "predictedValue_CLASS":"predictedValue_CLASS.SVALUE", "Cluster ID":"Cluster ID.SVALUE", "Cluster Affinity for predicted":"Cluster Affinity for predicted.PVALUE.testOut1", "Cluster Affinity for setosa":"Cluster Affinity for setosa.PVALUE.testOut2", "Cluster Affinity for versic":"Cluster Affinity for versic.PVALUE.testOut3", "Cluster Affinity for virgin":"Cluster Affinity for virgin.PVALUE.testOut4", "modelName":"Iris_KM", "pmmlFileName":"Iris_KM.pmml", "pmmlFileDirectory":"'+self.PMMLMODELS+'"})')
	...
	def validate(self):
		...
		exprList=[]
		exprList.append('Validating com.industry.analytics.Analytic\("Prediction",\["SEPAL_LE","SEPAL_WI","PETAL_LE","PETAL_WI"\],\["predictedValue_CLASS","Cluster ID","Cluster Affinity for predicted","Cluster Affinity for setosa","Cluster Affinity for versic","Cluster Affinity for virgin"\],{"Cluster Affinity for predicted":"Cluster Affinity for predicted.PVALUE.testOut1","Cluster Affinity for setosa":"Cluster Affinity for setosa.PVALUE.testOut2","Cluster Affinity for versic":"Cluster Affinity for versic.PVALUE.testOut3","Cluster Affinity for virgin":"Cluster Affinity for virgin.PVALUE.testOut4","Cluster ID":"Cluster ID.SVALUE","PETAL_LE":"PETAL_LE.DVALUE","PETAL_WI":"PETAL_WI.DVALUE","SEPAL_LE":"SEPAL_LE.DVALUE","SEPAL_WI":"SEPAL_WI.DVALUE","modelName":"Iris_KM","pmmlFileDirectory":".*/tests/tools/models","pmmlFileName":"Iris_KM.pmml","predictedValue_CLASS":"predictedValue_CLASS.SVALUE"}\)')
