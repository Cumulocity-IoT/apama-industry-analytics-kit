...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		self.waitForSignal('correlator.out', expr='Analytic OnTimeArrival started for inputDataNames', condition='==1', timeout=5)
	...
	def validate(self):
		...
		self.assertGrep('correlator.out', expr='The arrival was not late but was received after the ETA ellapsed', condition='==1')
		self.checkSanity()	
