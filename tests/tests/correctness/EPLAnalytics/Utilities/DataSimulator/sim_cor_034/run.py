...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		exprList.append('Received Data: -3.33333333333333')
		...
		exprList.append('Received Data: -29.99999999999999')
		exprList.append('Received Data: -33.33333333333332')
		exprList.append('Received Data: -36.66666666666666')
		exprList.append('Received Data: -39.99999999999999')
		...
		# Ensure the test output was correct
		exprList=[]
		exprList.append('Validating com.industry.analytics.Analytic\("DataSimulator",\[\],\["OutputData"\],{"rangeLower":"-50","rangeUpper":"50","simulationType":"sawfalling"}\)')
