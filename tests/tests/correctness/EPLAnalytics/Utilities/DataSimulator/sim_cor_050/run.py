...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		exprList.append('Received Data: 6.666666666666667')
		...
		exprList.append('Received Data: 93.33333333333334')
		...
		# Ensure the test output was correct
		exprList=[]
		exprList.append('Validating com.industry.analytics.Analytic\("DataSimulator",\[\],\["OutputData"\],{"simulationType":"triangle"}\)')
