...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		for sourceId in [1,2,3] :
			...
			exprList.append('Received Data: sourceId:ID_%s dValue:3.333333333333333'%sourceId)
			exprList.append('Received Data: sourceId:ID_%s dValue:6.666666666666666'%sourceId)
			exprList.append('Received Data: sourceId:ID_%s dValue:9.999999999999999'%sourceId)
			...
			exprList.append('Received Data: sourceId:ID_%s dValue:46.66666666666666'%sourceId)
			...
			exprList.append('Received Data: sourceId:ID_%s dValue:6.66666666666667'%sourceId)
			exprList.append('Received Data: sourceId:ID_%s dValue:3.33333333333334'%sourceId)
			exprList.append('Received Data: sourceId:ID_%s dValue:0'%sourceId)
			exprList.append('Received Data: sourceId:ID_%s dValue:3.333333333333333'%sourceId)
		...
		# Ensure the test output was correct
		exprList=[]
		exprList.append('Validating com.industry.analytics.Analytic\("DataSimulator",\[\],\["OutputData"\],{"dataRateUnit":"perMinute","dataRateValue":"60","rangeLower":"0","rangeUpper":"50","simulationType":"triangle","sourceIdCount":"3","sourceIdPrefix":"ID_"}\)')
