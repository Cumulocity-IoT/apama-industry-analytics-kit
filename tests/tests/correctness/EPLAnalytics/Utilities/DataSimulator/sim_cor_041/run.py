...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		# Ensure the test output was correct
		exprList=[]
		exprList.append('Validating com.industry.analytics.Analytic\("DataSimulator",\[\],\["OutputData"\],{"dataRateUnit":"perMinute","dataRateValue":"60","rangeLower":"0","rangeUpper":"50","simulationType":"square","sourceIdCount":"1","sourceIdPrefix":"ID_"}\)')
