...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		exprList.append('Received Data: 47.33333333333334')
		...
		exprList.append('Received Data: 18')
		exprList.append('Received Data: 15.33333333333333')
		exprList.append('Received Data: 12.66666666666666')
		exprList.append('Received Data: 10')
		exprList.append('Received Data: 12.66666666666667')
		...
		# Ensure the test output was correct
		exprList=[]
		exprList.append('Validating com.industry.analytics.Analytic\("DataSimulator",\[\],\["OutputData"\],{"rangeLower":"10","rangeUpper":"50","simulationType":"triangle"}\)')
