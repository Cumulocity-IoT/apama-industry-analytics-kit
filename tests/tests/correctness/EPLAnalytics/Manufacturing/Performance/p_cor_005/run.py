...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		self.injectPerformance(correlator)
		...
		self.waitForSignal('correlator.out', expr='Analytic Performance started for inputDataNames', condition='==2', timeout=5)

		correlator.send('Events.evt')
		self.waitForSignal('notBySourceId.evt', expr='com\.industry\.analytics\.Data', condition='==11', timeout=5)
