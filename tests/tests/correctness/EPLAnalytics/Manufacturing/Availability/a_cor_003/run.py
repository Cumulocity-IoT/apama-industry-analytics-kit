...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		self.injectAvailability(correlator)
		...
		self.waitForSignal('correlator.out', expr='Analytic Availability started for inputDataNames', condition='==2', timeout=5)

		correlator.send('Events.evt')
		self.waitForSignal('notBySourceId.evt', expr='com\.industry\.analytics\.Data', condition='==7', timeout=5)
