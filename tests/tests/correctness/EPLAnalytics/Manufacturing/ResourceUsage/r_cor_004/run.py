...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		self.waitForSignal('correlator.out', expr='Analytic ResourceUsage started for inputDataNames', condition='==2', timeout=5)

		correlator.send('Events.evt')
		self.waitForSignal('notBySourceId.evt', expr='com\.industry\.analytics\.Data', condition='==9', timeout=5)
