...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		correlator.receive(filename='SpikeResult.evt', channels=['SpikeResult'])
		...
		self.waitForSignal('SpikeResult.evt',
	...
	def validate(self):
		self.assertDiff('SpikeResult.evt', 'SpikeResult.evt')
