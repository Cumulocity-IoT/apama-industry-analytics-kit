...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		self.assertGrep('OutputRising.evt', expr='com.industry.analytics.Data.*"OutputRising","a","s1",25,11,"",1,2,3,{"anomalySource":"Corridor","duration":"10","zone":"outside"}')
		self.assertGrep('OutputRising.evt', expr='com.industry.analytics.Data.*"OutputRising","a","s1",35,12,"",1,2,3,{"anomalySource":"Corridor","duration":"20","zone":"outside"}')
		self.checkSanity()	
