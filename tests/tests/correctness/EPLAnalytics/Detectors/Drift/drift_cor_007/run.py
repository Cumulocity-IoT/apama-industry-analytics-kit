...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		self.assertLineCount('correlator.log', expr='Validating com.industry.analytics.Analytic\("Drift",\["Input"\],\["OutputValue"\],{"lowerOffsetOverride":"3","offset":"2","offsetType":"absolute"}\)', condition='==1')
		self.assertLineCount('correlator.log', expr='Validating com.industry.analytics.Analytic\("Drift",\["Input"\],\["OutputPercentage"\],{"lowerOffsetOverride":"20","offset":"10","offsetType":"percentage"}\)', condition='==1')
		self.assertLineCount('correlator.log', expr='Validating com.industry.analytics.Analytic\("Drift",\["Input"\],\["OutputStandardDeviation"\],{"lowerOffsetOverride":"1","offset":"2","offsetType":"stddev"}\)', condition='==1')
