...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		exprList.append('TEST PASSED: 22')
		exprList.append('TEST PASSED: 23')
		exprList.append('TEST PASSED: 24')
		exprList.append('TEST PASSED: 25')
		exprList.append('TEST PASSED: 26')
		exprList.append('TEST PASSED: 27')
		exprList.append('TEST PASSED: 28')
		exprList.append('TEST PASSED: 29')
		...
		self.assertLineCount('correlator.out', expr='TEST PASSED', condition='==19')
		self.assertLineCount('correlator.out', expr='FAILED TO CREATE ANALYTIC:', condition='==10')
