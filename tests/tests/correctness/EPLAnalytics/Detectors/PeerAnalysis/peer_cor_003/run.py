...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		exprList.append('FAILED TO CREATE ANALYTIC: 23')
		...
		self.assertLineCount('correlator.out', expr='TEST PASSED', condition='==1')
		self.assertLineCount('correlator.out', expr='FAILED TO CREATE ANALYTIC:', condition='==22')
