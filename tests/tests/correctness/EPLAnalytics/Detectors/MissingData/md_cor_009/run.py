...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		exprList.append('FAILED TO CREATE ANALYTIC: 21')
		exprList.append('FAILED TO CREATE ANALYTIC: 22')
		...
		self.assertLineCount('correlator.out', expr='TEST PASSED', condition='==13')
		self.assertLineCount('correlator.out', expr='FAILED TO CREATE ANALYTIC:', condition='==12')