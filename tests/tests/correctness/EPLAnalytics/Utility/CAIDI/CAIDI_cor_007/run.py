...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		self.assertGrep('Correlator.out', expr='Data event contain either 0 or negative value for interrupted customers or restoration time', condition='==2')
		self.checkSanity()	
