...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		self.assertGrep('Output1.evt', expr='com\.industry\.analytics\.Data\("Output1","c","s1",0,0\..*,"",0,0,0,\{\}\)')
		self.assertGrep('Output2.evt', expr='com\.industry\.analytics\.Data\("Output2","c","s1",0,-0\..*,"",0,0,0,\{\}\)')
