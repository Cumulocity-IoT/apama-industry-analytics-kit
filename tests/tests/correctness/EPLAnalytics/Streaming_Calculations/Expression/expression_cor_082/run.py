...
class PySysTest(AnalyticsBaseTest):
	...
	def validate(self):
		...
		self.assertLineCount('correlator.out', expr='Validating com.industry.analytics.Analytic\("Expression",.*\)', condition='==9')
		self.assertLineCount('correlator.out', expr='Error spawning Expression instance.', condition='==2')
		self.assertLineCount('correlator.out', expr='Analytic Expression started for inputDataNames', condition='==7')
