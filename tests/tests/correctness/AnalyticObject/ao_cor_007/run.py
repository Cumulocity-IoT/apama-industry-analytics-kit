...
class PySysTest(AnalyticsBaseTest):
	def execute(self):
		...
		self.waitForSignal('correlator.out', expr='RECEIVED DATA ON ', condition='==18', timeout=5)
	...
	def validate(self):
		...
		self.assertLineCount('correlator.out', expr='RECEIVED DATA ON TEST_DATA_2: com.industry.analytics.Data\("TEST_DATA_2","r","TEST_ASSET",0,666.6,"TEST_STRING",1,2,3,{}\)', condition='==3')
		self.assertLineCount('correlator.out', expr='RECEIVED DATA ON TEST_DATA_3: com.industry.analytics.Data\("TEST_DATA_3","r","TEST_ASSET",0,666.6,"TEST_STRING",1,2,3,{}\)', condition='==3')
